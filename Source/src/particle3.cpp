...
//********************************************************************************
Particle3Type::Particle3Type(int maxParticles, char *textureName, float size)
{
...
//********************************************************************************
void Particle3Type::SetEmissionPoint(D3DXVECTOR3 point)
{
...
//********************************************************************************
void Particle3Type::SetEmissionBox  (D3DXVECTOR3 least, D3DXVECTOR3 most)
{
...
//********************************************************************************
void Particle3Type::Emit(int amount, D3DXCOLOR color)
{
	int exit = FALSE;
...
//********************************************************************************
void Particle3Type::Tick(float timeDelta)
{
	for (int i = 0; i < numOfParticles; ++i)
	{
...
//********************************************************************************
void Particle3Type::PrepareToDraw(void)
{
...
//********************************************************************************
void Particle3Type::Draw(D3DXMATRIX matTrans)
{
//	camAngle *= 1;
...
//   puma->m_pd3dDevice->SetRenderState( D3DRS_POINTSIZE,     FtoDW(particleSize) ); // size!
	...
	for (int i = 0; i < numOfParticles; ++i)
	{
		...
		if (particleArray[i].life >= 0)
		{
			...
			for (int j = 0; j < 4; ++j)
			{
				if (particleArray[i].life < 70)
					tempF = (particleArray[i].life / 70.0f);
				else if (particleArray[i].life < 140)
					tempF = 1;//alpha[j];
				else
					tempF = 1.0f - (particleArray[i].life - 140) / 70.0f;
				alpha[j] = tempF;
			}
