...
public:
    ...
    HRESULT BuildDeviceList(int startInWindow);
    ...
    static BOOL CALLBACK SelectDeviceProc( HWND hDlg, UINT msg, 
    ...
    virtual HRESULT Create( HINSTANCE hInstance, int startInWindow );
    virtual INT     Run();
