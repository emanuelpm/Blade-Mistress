...
//******************************************************************
//******************************************************************
ArmyDragons::ArmyDragons(SharedSpace *s, int centerX, int centerY, int sX, int sY, int armyIndex) : BBOSArmy(s, centerX, centerY)
{
	// create an army of the dragons
...
//******************************************************************
ArmyDragons::~ArmyDragons()
{

}

//******************************************************************
BBOSMonster *ArmyDragons::MakeSpecialMonster(ArmyMember *curMember)
{
	/*
	if (-1 == curMember->type)
	{
