...
//********************************************************************************
ParticleScaleType::ParticleScaleType(int maxParticles, char *textureName, float delta)
{
   ...
   puma->m_pd3dDevice->CreateVertexBuffer( (numOfParticles + 1) * 
	...
	particleArray = new ParticleScale[numOfParticles];
...
//********************************************************************************
ParticleScaleType::~ParticleScaleType()
{
...
//********************************************************************************
void ParticleScaleType::SetEmissionPoint(D3DXVECTOR3 point)
{
...
//********************************************************************************
void ParticleScaleType::SetEmissionBox  (D3DXVECTOR3 least, D3DXVECTOR3 most)
{
...
//********************************************************************************
void ParticleScaleType::Emit(int amount, D3DXCOLOR color, float scale)
{
	int exit = FALSE;
...
//********************************************************************************
void ParticleScaleType::Tick(float timeDelta)
{
	for (int i = 0; i < numOfParticles; ++i)
	{
...
//********************************************************************************
void ParticleScaleType::PrepareToDraw(void)
{
...
//********************************************************************************
void ParticleScaleType::Draw(D3DXMATRIX matTrans)
{
//	camAngle *= 1;
